...
Unity includes EditMode NUnit tests for coincident-body finiteness, the analytical gradient, and invalid-parameter rejection. Unreal includes automation coverage for the corresponding solver behavior when built inside an Unreal project.
